...
const Offer = () => {
    return (
        <div id='offer' style={{ backgroundImage: `url(${bg1})`,  width: "100vw", backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
            <div className=" mt-5 row d-flex justify-content-center align-items-center p-5">
