...
//               <div
//                 className="d-flex flex-column justify-content-center align-items-center p-3 rounded"
//                 style={{ backgroundColor: `rgb(224, 255, 192, 0.6)` }}
//               >
//                 <h5>100% Healthy & Affordable</h5>
//                 <h1 className="text-success fw-bold fst-italic pt-3">
//                   ORGANIC
//                 </h1>
//                 <h1 className="text-success fw-bold fst-italic pb-3">
//                   VEGETABLES
//                 </h1>
...
//                   as={Link}
//                   to="/manage"
//                   className="px-5 py-2 mt-3 rounded-pill fs-5"
//                   variant="success"
//                   type="submit"
//                 >
//                   Shop Now
...
//               <div
//                 className="d-flex flex-column justify-content-center align-items-center p-3 rounded"
//                 style={{ backgroundColor: `rgb(253, 232, 95, 0.6)` }}
//               >
//                 <h4>Groca</h4>
//                 <h1 className="text-danger fw-bold fst-italic pt-2">
//                   VEGETABLES 100%
//                 </h1>
...
//             <div className="col-md-6 col-sm-12 d-block ms-auto py-5 d-flex align-items-center justify-content-center h-100 ">
//               <div
//                 className="d-flex flex-column justify-content-center align-items-center bg-gradient p-3 rounded"
//                 style={{ backgroundColor: `rgb(240, 223, 202, 0.6)` }}
//               >
//                 <h5>Natural Health Care Ingredients</h5>
//                 <h1 className="text-warning fw-bold fst-italic pt-3">
//                   GROCERY
//                 </h1>
//                 <h1 className="text-warning fw-bold fst-italic pb-3">
//                   SHOPPING
//                 </h1>
