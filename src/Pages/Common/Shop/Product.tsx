  ...
  return (
    <div className="border hover:border-green-400 rounded p-5 hover:shadow-2xl shadow-green-500 hover:bg-white transition-all duration-300 ">
      ...
      <div>
        ...
        <div>
          <div className="hover:bg-green-500 transition-all duration-300 hover:text-white text-md font-semibold text-green-500 rounded-3xl px-6 border border-green-400 py-2 mt-4">
            Add to Cart
          </div>
        </div>
      </div>
